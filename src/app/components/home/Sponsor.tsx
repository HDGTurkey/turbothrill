  ...
  return (
    <>
      ...
      <div className="tp-news-letter-area">
        <div className="tp-suscribe-newslatter theme-bg pt-40 pb-40" style={{ backgroundImage: `url(${bg_img})`, backgroundRepeat: 'no-repeat' }}>
          <div className="container">
            <div className="row align-items-center">
              <div className="">
                <div className="tp-newsletter-title ">
                  <h3 className="tp-news-title">Thanks to all our supporters and partners!</h3>
                  <p className='text-white pt-5'>Our contact e-mail for partnership: hsdbeykeynt@gmail.com</p>
                </div>
              </div>
