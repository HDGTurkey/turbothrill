      ...
      <div className=" py-10 px-10 max-w-7xl mx-auto ">
         <div className="text-left">
            ...
            <p className="text-md my-3">
               At sessions that span from the technical to the visionary, let’s celebrate and discover what the
               technologies can enable: how product innovation, open source, and ML and AI can propel enterprises
