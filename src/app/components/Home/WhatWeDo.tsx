...
const services_data = [
  {
    ...
    text_1:
      'Benzer Bir Teknoloji Tutkusuna Sahip Öğrenci Geliştiricilerle Tanışın, Fikir Alışverişinde Bulunun',
    text_2: '',
    home: true,
    service_p_2: true,
  },
  {
    ...
    title: 'Öğrenin',
    text_1:
      'Topluluğumuzun Sunduğu Eğlenceli ve Bilgilendirici Etkinliklerle Kendinizi Geliştirin.',
    home: true,
    service_p_2: true,
  },
  {
    ...
    title: 'Gelişin',
    text_1:
      'Topluluk İçindeki Deneyim Paylaşımları ile Yeni Perspektifler Kazanın.',
    home: true,
    service_p_2: true,
  },
]
