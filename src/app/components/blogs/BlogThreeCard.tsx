            ...
            <Link
               ...
               className={`transition-all p-5 ${
                  data.theme === 'light'
                     ...
                     : 'bg-[#262626] from-gray-800 text-white hover:bg-[#333333] shadow-md'
               } rounded-sm p-2`}
            >
               ...
               <div className="my-auto mx-auto px-10 text-left ">
                  <Link href={`${blogData.link}`}>
                     <h3 className="text-2xl py-2 font-bold  postbox__title">{blogData.title}</h3>
                  </Link>
                  <div className="meta-post">
                     <a href="/home" className="pr-2 border-r-2 border-green-900">
                        {blogData.author}
                     </a>
                  ...
                  <div className="pb-5 pt-5">
                     <button
                        type="button"
                        className=" pb-3 text-white bg-[#ec373c] hover:bg-[#cc2e32  font-medium rounded-md text-sm px-5 py-2.5 text-center inline-flex items-center"
                     >
