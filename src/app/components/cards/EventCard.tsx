...
export const EventCard = (events: any) => {
  return (
    <>
      <div className="w-[650px] rounded border border-gray-100 bg-white shadow-xl">
        <div className="mx-5 text-xl">
          <img
            ...
            alt="Event"
            className="w-full rounded-t  pt-4"
          />
        </div>
        <div className="p-5">
          <div className="mb-2 text-xl font-bold text-black">Event Name</div>
