                     ...
                     <div className="flex flex-wrap justify-center max-w[1200px] gap-8 mb-8">
                        ...
                        >
                           ...
                           <div className="card__body flex flex-col gap-3 p-4 ">
                              ...
                              <h4 className={`capitalize text-2xl  ${data.theme === 'light' ? ' ' : ' '}`}>
                                 {' '}
                                 {blog.title.length > 20 ? `${blog.title.substring(0, 20)}...` : blog.title}
                              </h4>
                              <p className="text-left">
                                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi perferendis molestiae
                                 non nemo doloribus. Doloremque, nihil! At ea atque quidem!
                              </p>
                           </div>
