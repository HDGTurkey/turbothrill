...
const hero_contents = {
	...
	text: <>HUAWEI Student Developers(HSD) is a college and university with a passion for leading-edge technologies. It is a global program for university students.</>,
