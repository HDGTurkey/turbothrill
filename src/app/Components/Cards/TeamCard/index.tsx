		...
		<div className={` flex flex-col  items-center  rounded-xl m-3 p-5  ${theme === 'light' ? 'bg-white shadow-xl  shadow-gray-300 hover:bg-gray-100 ' : ' bg-card-dark shadow-2xl hover:bg-gray-800'}`}>
			...
			<div className="flex items-center">
				{teamData.linkedin && (
					...
					>
						<svg className=" w-4 h-4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="23" height="48" viewBox="0 0 48 48">
							<path
				...
				{teamData.github && (
					...
					>
						<svg className=" w-4 h-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
							<path
								fill="currentColor"
				...
				{teamData.twitter && (
					...
					>
						<svg className="w-4 h-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
							<path
								fill="currentColor"
