		...
		<>
			<div className="bg-white shadow-xl rounded border w-[650px] border-gray-100">
				<div className="text-xl mx-5">
					<img src="https://www.meetup.com/_next/image/?url=https%3A%2F%2Fsecure-content.meetupstatic.com%2Fimages%2Fclassic-events%2F508957542%2F676x380.webp&w=3840&q=75" alt="Event" className="w-full pt-4  rounded-t" />
				</div>
				<div className="p-5">
