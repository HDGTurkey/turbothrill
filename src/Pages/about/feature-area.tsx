			...
			<div className="ac-feature-area">
				<div className="container">
					...
					<div className="ac-feature-border-top">
						<div className="row ">
							<FeatureItem title={'Application'} subtitle={''} />
							<FeatureItem title={'Interview with National Project Managers'} subtitle={''} />
							<FeatureItem title={'Interview with Global Project Managers'} subtitle={''} />
							<FeatureItem title={'Certificate'} subtitle={''} />
						</div>
					</div>
				</div>
			</div>
