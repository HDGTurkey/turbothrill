...
const ChoseItem: React.FC<ChoseItemProps> = ({ duration, delay, item_num, icon, title, text, color }) => {
	return (
		<div className="col-xl-3 col-lg-6 col-md-6 col-12 wow tpfadeUp" data-wow-duration={duration} data-wow-delay={delay}>
				...
				<div className=" ac-chose-bg">
					<div className="row">
						...
						<ChoseItem
							...
							text={'Community ambassadors and members can receive training in many areas that a student may need and participate in all HSD-related events.'}
						/>
						<ChoseItem
							duration=".7s"
							delay=".9s"
