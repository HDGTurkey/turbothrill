...
const EventDetailPage: React.FC = () => {
     ...
     const data = EventClassic.filter((event: Event) => event.slug_name === lowercaseTitle);
  
     return (
          <div className='max-w-6xl mx-8 '>
               <div className='flex text-2xl text-left max-w-6xl mx-auto p-5 '>
                    <div className=' flex-1'>
                         <h1 className="text-3xl font-bold mb-3">{data[0]?.name}</h1>
                    </div>
               </div>
               <div className=' bg-gray-100 shadow-lg grid grid-cols-1 lg:grid-cols-2 lg:flex'>
                    <div className=' w-auto '>
                         <div className=' px-5'>
                              ...
                              <p className='text-left m-5 '>{data[0]?.description}
                              </p>
                         </div>
                    </div>
                    <div className='min-w-[300px] m-5   '>
                         ...
                         <div className='mb-3 bg-red-100 flex rounded-lg'>
                              ...
                              <p className='text-lg font-bold mx-5'>{data[0]?.state}</p>
                         </div>


                         <div className='p-5 mb-5  border-solid border-2 shadow-md w-auto rounded-lg flex items-start   '>
                              <img alt="img" className='w-5 h-5' src="https://img.icons8.com/material-outlined/24/null/calendar--v1.png" />
                              <p className=' '>{data[0]?.date}</p>
                         </div>
                         <div className='p-5 mb-5 border-solid border-2 shadow-md w-auto rounded-lg flex items-start'>
                              ...
                              <div className='justify-items-start mx-2'>
                                   <p>{data[0]?.locName}</p>
                                   <p>{data[0]?.locAddress}</p>
                              </div>
                         </div>
                         <div className=' p-5 mb-5  border-solid border-2 shadow-md rounded-lg w-auto'>
