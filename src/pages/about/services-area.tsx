...
const ChoseItem: React.FC<ChoseItemProps> = ({
  duration,
  delay,
  item_num,
  icon,
        ...
        <div className=" ac-chose-bg">
          <div className="row">
            <ChoseItem
              ...
              text={
                'Benzer bir teknoloji tutkusuna sahip öğrenci geliştiricilerle tanışın, fikir alışverişinde bulunun ve yeni projeler üzerinde işbirliği yapın.'
              }
            />
            <ChoseItem
              duration=".5s"
              ...
              text={
                'Topluluk elçileri ve üyeleri, bir öğrencinin ihtiyaç duyabileceği birçok alanda eğitimler alabilir ve HSD ile ilgili düzenlenen tüm etkinliklere katılabilir.'
              }
            />
            <ChoseItem
              duration=".7s"
