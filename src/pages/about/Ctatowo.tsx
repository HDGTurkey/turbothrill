...
const CtaTwo = () => {
  return (
    <div className="tp-news-letter-area tp-news-letter-bg pt-35 pb-30"
          ...
          <div className="col-xl-7 col-lg-7 col-md-12 ">
            <div className="tp-news-sub-wrapper pr-50">
              <div className="tp-news-letter-section-box">
                <h2 className="tp-title-sm tp-title-sm tp-white-text pb-25 wow tpfadeUp" data-wow-duration=".5s" data-wow-delay=".8s">We look forward
                to hearing from you
                </h2>
              </div>
              ...
              <div className="tp-news-button wow tpfadeUp" data-wow-duration=".7s" data-wow-delay="1s">
                <a href='' className="tp-btn-sky">Join Us</a>
              </div>
            </div>
          </div>
