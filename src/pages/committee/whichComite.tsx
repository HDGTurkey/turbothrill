    ...
    <>
      <div className="tp-news-area black-bg fix">
        <div className="container">
          <div className="row align-items-end flex-md-wrap flex-wrap-reverse">
            <div className="col-xl-6 col-lg-6 col-md-6">
              <div
                className="tp-newsletter-left-img p-relative wow tpfadeLeft pt-10"
              ...
              >
                ...
                <div className="news-shape-img">
                  <img
                    src="/assets/img/creative/creative-circle-img.png"
                    alt=""
                  />
                </div>
              </div>
